...
import com.dwakenya.homecarehub.newdwa.holders.Subscriptions;
...
public class MpesaActivityEmployee extends AppCompatActivity {
    ...
    private String URL = "https://techsavanna.net:8181/dwa/getEmployeeSubs.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpesa_employee);
...
//        sendContinue.findViewById(R.id.sendContinue);
        ...
        SharedPreferences sharedPref = MpesaActivityEmployee.this.getSharedPreferences("details", Context.MODE_PRIVATE);
        final String phoneee = sharedPref.getString("phoneee", "");
    
        editTextPhoneNumber.setText(phoneee);
...
//                            detailIntent.putExtra("result_code", result_code);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MpesaActivityEmployee.this);
                ...
                try{
                    ...
                    if(obj.optString("status").equals("true")){
                        ...
                        for (int i = 0; i<mySubscriptionList.size();i++){
                            ...
                            finalid = Integer.parseInt(mysubs7);
    
                            String SubTotal = mysubs7+" "+mysub9;
                            String LastSub = SubTotal.replaceAll("[^a-zA-Z]", "");
    
    
                            mySubscription.add(LastSub);
                    ...
                    spinner.setAdapter(new ArrayAdapter<>(MpesaActivityEmployee.this, R.layout.myspinner, mySubscription));
                }catch (JSONException e){
                    e.printStackTrace();
