package com.dwakenya.homecarehub.newdwa.adapters;
        ...
        import com.dwakenya.homecarehub.newdwa.DetailsActivity;
        import com.dwakenya.homecarehub.newdwa.MpesaActivity;
        import com.dwakenya.homecarehub.newdwa.MpesaActivityEmployee;
        import com.dwakenya.homecarehub.newdwa.R;
        import com.dwakenya.homecarehub.newdwa.helpers.EmployeeFilter;
        import com.dwakenya.homecarehub.newdwa.helpers.SQLiteHandler;
        import com.dwakenya.homecarehub.newdwa.holders.CheckSubscriptions;
        import com.dwakenya.homecarehub.newdwa.holders.Employee;
        import com.dwakenya.homecarehub.newdwa.holders.EmployeeHolder;
        import com.dwakenya.homecarehub.newdwa.interfaces.ItemClickListener;
...
//        holder.img.setImageResource(players.get(position).getImage_url());
        ...
        //Glide.with(c).load(employees.get(position).getImage_url()).into(holder.img);
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClick(final View v, final int pos) {
                ...
                SharedPreferences sharedPref = v.getContext().getSharedPreferences("details", Context.MODE_PRIVATE);
                final String usertype = sharedPref.getString("type", "");
                final String phoneee = sharedPref.getString("phoneee", "");
...
//                final String phoneee = detailIntent.getStringExtra("phoneee");
                ...
                StringRequest stringRequest1 = new StringRequest(Request.Method.GET, "https://techsavanna.net:8181/dwa/mpesaApis.php?partya=" + finalPhone, new Response.Listener<String>() {
                        ...
                        try {
                            ...
                            if (obj.optString("error").equals("false")) {
                                ...
                                if (usertype.equals("0")) {
                                    ...
                                    mpesa.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//                                System.out.println("Countdown: "+countdown1);
                                ...
                                if (!countdown1.equals(confirm_date1)) {
                                    ...
                                    if (!mpesa_receipt_number1.equals("") && finalPhone.equals(phoney) && result_code1.equals("0")) {
                                        ...
                                        Toast.makeText(c, "You have already paid for your subscription", Toast.LENGTH_LONG).show();
                                    } else {
