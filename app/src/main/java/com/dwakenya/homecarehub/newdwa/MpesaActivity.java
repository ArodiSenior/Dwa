...
//        sendContinue.findViewById(R.id.sendContinue);
        ...
        SharedPreferences sharedPref = MpesaActivity.this.getSharedPreferences("details", Context.MODE_PRIVATE);
                ...
                try{
                    ...
                    if(obj.optString("status").equals("true")){
                        ...
                        for (int i = 0; i<mySubscriptionList.size();i++){
                            ...
                            //Toast.makeText(MpesaActivity.this, SubTotal, Toast.LENGTH_SHORT).show();
