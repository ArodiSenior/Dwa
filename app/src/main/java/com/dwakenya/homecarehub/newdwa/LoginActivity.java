...
import com.dwakenya.homecarehub.newdwa.helpers.NotificationUtils;
...
public class LoginActivity extends AppCompatActivity {
    ...
    Button _loginButton;
    TextView _signupLink, ResetPassword;
...
//        inputLayoutPassword = (TextInputLayout) findViewById(R.id.input_layout_password);
                ...
                SharedPreferences sharedPref = getSharedPreferences("Logdetails", Context.MODE_PRIVATE);
                final String emaildet = sharedPref.getString("email", "");
                final String passworddet = sharedPref.getString("password", "");
    
                _emailText.setText(emaildet);
                _passwordText.setText(passworddet);
...
//
                                        ...
                                        session.createLoginSession(name, email, uid, phone, status, user_type,location, preference_skill, image_path, fname, lname, id, password);
                                        // Not Sure is the
                                        ...
                                        if (user_type.equals("1")) {
                                            ...
                                            editor.putString("phoneee",phone);
                                            editor.apply();
