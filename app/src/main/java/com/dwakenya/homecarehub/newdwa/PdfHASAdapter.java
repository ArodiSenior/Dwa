...
public class PdfHASAdapter extends RecyclerView.Adapter<PdfHASAdapter.PdfHASViewHolder>{
        ...
        @Override
        public PdfHASViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new PdfHASViewHolder(LayoutInflater.from(context).inflate(R.layout.pdfraw, parent, false));
        }
        
        @Override
        public void onBindViewHolder(PdfHASViewHolder holder, final int position) {
