...
public class ContractAdapter extends RecyclerView.Adapter<ContractAdapter.ContractHolder> {
        ...
        public ContractHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ContractHolder(LayoutInflater.from(context).inflate(R.layout.pdfraw, parent, false));
        }
        
        @Override
        public void onBindViewHolder(ContractHolder holder, final int position) {
